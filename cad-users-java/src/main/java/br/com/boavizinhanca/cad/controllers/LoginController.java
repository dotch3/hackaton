...
public class LoginController {
    ...
    @CrossOrigin(origins = {"http://54.163.66.128:8080","http://localhost","http://localhost:8080","http://localhost:8081","http://localhost:8888","http://54.163.66.128:8081","http://204.236.210.118"},maxAge=4800, allowCredentials="false")
